package.path = package.path .. ";/disk/station_files/?.lua"
...
local file_list = utils.recursive_file_list("/disk/station_files", file_blacklist)
...
for _, path in ipairs(file_list) do
    ...
    table.insert(tasks, function()
        ...
        hashes[path:gsub("disk/station_files/", "")] = sha256.hash(message)
